...
with model_graph.as_default():
    ...
    with tf_session.as_default():
        ...
        #model = jb.load('./models/5_disease_model.h5')
        modeli = load_model("./models/5_disease_model.h5")
...
def index(request):
    context={'a':1}
    return render(request,'checkdisease.html',context)
...
def predictImage(request):
    ...
    if r == 0:
        prediction = 'Acne and Rosacea'
    elif r == 1:
        prediction = 'Actinic Keratosis Basal Cell Carcinoma and other Malignant Lesions'
    elif r == 2:
        prediction = 'Atopic Dermatitis'
    elif r == 3:
        prediction = 'Bullous Disease'
    elif r == 4:
        prediction = 'Cellulitis Impetigo and other Bacterial Infections'
    elif r == 5:
        prediction = 'Eczema '
    elif r == 6:
        prediction = 'Exanthems and Drug Eruptions'
    elif r == 7:
        prediction = 'Hair Loss Photos Alopecia and other Hair Diseases'
    elif r == 8:
        prediction = 'Herpes HPV and other STDs Photos'
    elif r == 9:
        prediction = 'Light Diseases and Disorders of Pigmentation'
    elif r == 10:
        prediction = 'Lupus and other Connective Tissue diseases'
    elif r == 11:
        prediction = 'Melanoma Skin Cancer Nevi and Moles'
    elif r == 12:
        prediction = 'Nail Fungus and other Nail Disease'
    elif r == 13:
        prediction = 'Poison Ivy Photos and other Contact Dermatitis'
    elif r == 14:
        prediction = 'Psoriasis pictures Lichen Planus and related diseases'
    elif r == 15:
        prediction = 'Scabies Lyme Disease and other Infestations and Bites'
    elif r == 16:
        prediction = 'Seborrheic Keratoses and other Benign Tumors'
    elif r == 17:
        prediction = 'Systemic Disease'
    elif r == 18:
        prediction = 'Tinea Ringworm Candidiasis and other Fungal Infections'
    elif r == 19:
        prediction = 'Urticaria Hives'
    elif r == 20:
        prediction = 'Vascular Tumors'
    elif r == 21:
        prediction = 'Vasculitis'
    elif r == 22:
        prediction = 'Warts Molluscum and other Viral Infections' 
    else:
        prediction = 'Invalid Image. Please provide image related skin infection.'
        
    #print(prediction)
    #context=prediction 

    #print(predictedLabel)
    context={'filePathName':filePathName,'predictedLabel':prediction}
    
    return render(request,'ind.html',context)
    #return render(request,'patient/checkdisease/checkdisease.html',context)  
